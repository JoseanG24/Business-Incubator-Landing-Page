      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          ...
          <div className="flex justify-center mb-6 md:mb-0 text-3xl">
            <a href="https://www.facebook.com/UnisHub" className="mx-2 hover:text-blue-500"><FaFacebook /></a>
            <a href="https://www.youtube.com/UnisHub" className="mx-2 hover:text-red-600"><FaYoutube /></a>
            <a href="https://www.instagram.com/UnisHub" className="mx-2 hover:text-purple-400"><FaInstagram /></a>
          </div>
          <div className="mb-6 md:mb-0">
            <a href="#apply" className="inline-block bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded">Contáctanos</a>
          </div>
        </div>
